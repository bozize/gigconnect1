const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white py-8">
      <div className="container mx-auto w-full md:w-3/4 text-center">
        <p className="text-sm md:text-base">&copy; 2024 GigConnect. All rights reserved.</p>
        <ul className="flex flex-col md:flex-row justify-center space-y-2 md:space-y-0 md:space-x-6 mt-4">
          <li>
